package com.lucaseox.generatedappsfigmatemplates.generatedscreens.bestbuy
    ...
    Card(modifier = Modifier.fillMaxWidth(), shape = RoundedCornerShape(8.dp)) {
        Column(modifier = Modifier.padding(16.dp), verticalArrangement = Arrangement.spacedBy(8.dp)) {
            ...
            Row(verticalAlignment = Alignment.CenterVertically) {
                Image(painterResource(id = R.drawable.ic_placeholder), contentDescription = null, modifier = Modifier.size(64.dp))
            ...
            repeat(3) {
                Card(modifier = Modifier.size(160.dp, 200.dp), shape = RoundedCornerShape(8.dp)) {
                    Column(modifier = Modifier.padding(8.dp), verticalArrangement = Arrangement.spacedBy(4.dp)) {
                        Image(painterResource(id = R.drawable.ic_placeholder), contentDescription = null, modifier = Modifier.height(80.dp))
...
private fun SaleBanner() {
    Card(shape = RoundedCornerShape(8.dp)) {
        Box(contentAlignment = Alignment.BottomEnd) {
            Image(painterResource(id = R.drawable.ic_placeholder), contentDescription = null, modifier = Modifier.fillMaxWidth().height(120.dp))
...
private fun TotaltechMembership() {
    Card(shape = RoundedCornerShape(8.dp), modifier = Modifier.fillMaxWidth()) {
        Column(modifier = Modifier.padding(16.dp), verticalArrangement = Arrangement.spacedBy(8.dp)) {
            ...
            Image(painterResource(id = R.drawable.ic_placeholder), contentDescription = null, modifier = Modifier.fillMaxWidth().height(80.dp))

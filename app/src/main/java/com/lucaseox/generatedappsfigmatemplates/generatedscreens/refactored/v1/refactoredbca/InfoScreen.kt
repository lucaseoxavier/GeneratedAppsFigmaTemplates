...
private fun BottomNavigationBar() {
    NavigationBar(containerColor = Color(0xFF1E429F)) {
        ...
        NavigationBarItem(
            icon = { Icon(Icons.Default.AddCircle, contentDescription = "Transaction", tint = Color.White) },
            label = { Text("Transaction", color = Color.White) },
            selected = true,
            onClick = {}
        )
        NavigationBarItem(
            icon = { Icon(Icons.Default.AddCircle, contentDescription = "Central Action", tint = Color.White) },
            label = { Text("") },
            selected = false,
            onClick = {}
        )

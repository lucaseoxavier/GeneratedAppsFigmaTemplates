...
private fun ActionButtonsSection() {
    Row(
        ...
        ActionButton(Icons.Default.AddCircle, "Add Action Button")
        ActionButton(Icons.Default.ArrowForward, "Send Action Button")
        ActionButton(Icons.Default.AddCircle, "Virtual Account Button")
        IconButton(onClick = { }) {
            Icon(
...
private fun ActionButton(icon: androidx.compose.ui.graphics.vector.ImageVector, label: String) {
    Column(horizontalAlignment = Alignment.CenterHorizontally) {
        ...
        Text(text = label.split(" ")[0], fontSize = 12.sp)
    }
}
...
private fun TransactionItem(name: String, amount: String, isExpense: Boolean) {
    Row(
        ...
        Icon(
            ...
            contentDescription = if (isExpense) "Expense Transaction" else "Income Transaction",
            tint = if (isExpense) Color(0xFFD32F2F) else Color(0xFF1E7F2F),
    ...
    NavigationBar {
        ...
        NavigationBarItem(
            ...
            icon = {
                Icon(
                    imageVector = Icons.Default.AddCircle,
                    contentDescription = "Transaction Navigation"
                )
            },
        ...
        NavigationBarItem(
            ...
            icon = {
                Icon(
                    ...
                    contentDescription = "Notification Navigation"
                )
            },
...
private fun CenterFloatingActionButton() {
    FloatingActionButton(onClick = { }) {
        Image(
            ...
            contentDescription = "Center Floating Button"
        )
    }
}

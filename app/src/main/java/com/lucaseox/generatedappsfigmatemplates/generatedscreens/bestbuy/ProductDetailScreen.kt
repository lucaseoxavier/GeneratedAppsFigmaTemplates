...
private fun ProductInfoSection() {
    Text("ASUS", style = MaterialTheme.typography.titleMedium, color = Color.Blue)
    Text(
    ...
    Row(verticalAlignment = Alignment.CenterVertically) {
        repeat(4) {
            Icon(Icons.Default.AddCircle, contentDescription = "Star", tint = Color.Yellow)
        }
        Icon(Icons.Default.AddCircle, contentDescription = "Star", tint = Color.Gray)
...
private fun ProductExpandableOptions() {
    ...
    listOf("Overview", "Specifications", "Reviews", "Questions & Answers", "Buying Options").forEach {
        ...
        Row(
            ...
            Icon(Icons.Default.AddCircle, contentDescription = "$it Expand")
        }
    }
}

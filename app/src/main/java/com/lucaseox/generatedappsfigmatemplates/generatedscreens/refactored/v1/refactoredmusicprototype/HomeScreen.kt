package com.lucaseox.generatedappsfigmatemplates.generatedscreens.refactored.v1.refactoredmusicprototype
        ...
        LazyRow(horizontalArrangement = Arrangement.spacedBy(12.dp)) {
            items(5) { index ->
                Box(
                    ...
                    Image(
                        painter = painterResource(id = R.drawable.ic_placeholder),
                        contentDescription = "Popular image #${index + 1}",
        ...
        Column(verticalArrangement = Arrangement.spacedBy(16.dp)) {
            recentSongs.forEach { (title, artist) ->
                Row(verticalAlignment = Alignment.CenterVertically) {
                    Image(
                        painter = painterResource(id = R.drawable.ic_placeholder),
                        contentDescription = "Thumbnail for '$title' by $artist",
                        contentScale = ContentScale.Crop,
                        modifier = Modifier
                            .size(48.dp)

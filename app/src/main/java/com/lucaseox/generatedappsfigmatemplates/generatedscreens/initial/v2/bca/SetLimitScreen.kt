    ...
    Column(
        ...
        Column(horizontalAlignment = Alignment.CenterHorizontally, modifier = Modifier.fillMaxWidth()) {
            Row(verticalAlignment = Alignment.CenterVertically) {
                ...
                Icon(Icons.Default.AddCircle, contentDescription = null, tint = Color(0xFF1447B9), modifier = Modifier.size(16.dp))
            }
            Spacer(modifier = Modifier.height(4.dp))
            Row(verticalAlignment = Alignment.CenterVertically) {
                Text("Paspor BCA 9087890908", fontSize = 12.sp, color = Color.Gray)
                Spacer(modifier = Modifier.width(4.dp))
                Icon(Icons.Default.AddCircle, contentDescription = null, tint = Color.Gray, modifier = Modifier.size(12.dp))
            }
        }
...
private fun LimitSlider(title: String, maxAmount: String) {
    ...
    Column(modifier = Modifier.fillMaxWidth()) {
        ...
        Row(
            ...
            Text("Min.\n10.000", fontSize = 12.sp, color = Color.Gray)
            BasicTextField(
            ...
            Text("Min.\n$maxAmount", fontSize = 12.sp, color = Color.Gray, textAlign = TextAlign.End)
        }
        Spacer(modifier = Modifier.height(16.dp))
    }
}

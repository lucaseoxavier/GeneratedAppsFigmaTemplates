    ...
    Row(
        ...
        Column(horizontalAlignment = Alignment.CenterHorizontally, modifier = Modifier.fillMaxWidth()) {
            Text(
                ...
                color = Color(0xFF0077CC) // Higher contrast than #00AEEF
            )
            Text(
                text = "for all creatures great & small",
                fontSize = 12.sp,
                color = Color(0xFF4A4A4A) // Better contrast than #888888
            )
        }
    }
}
...
private fun BmiCheckerButton() {
    Button(
        ...
        colors = ButtonDefaults.buttonColors(
            containerColor = Color(0xFF9C27B0), // Purple with high contrast

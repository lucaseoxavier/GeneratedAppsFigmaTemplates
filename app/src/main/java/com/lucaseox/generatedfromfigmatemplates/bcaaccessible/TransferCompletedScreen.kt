...
private fun ConfirmationSection() {
    Column(
        ...
        Box(
            modifier = Modifier
                .size(100.dp)
                .background(Color(0xFF00C853), CircleShape), // Updated color for better contrast
            contentAlignment = Alignment.Center
        ) {
            Icon(
                painter = painterResource(id = android.R.drawable.checkbox_on_background),
                contentDescription = "Confirmation Check Icon",
                tint = Color.White,
        ...
        Row(
            ...
            Column {
                ...
                Text(
                    text = "9087890908",
                    style = TextStyle(
                        color = Color(0xFF616161), // Updated text color for better contrast
                        fontSize = 14.sp
                    )
                )
            }

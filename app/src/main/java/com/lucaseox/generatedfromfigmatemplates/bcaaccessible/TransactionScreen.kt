...
private fun BalanceSection() {
    Box(
        modifier = Modifier
            .fillMaxWidth()
            .padding(16.dp)
            .background(Color(0xFF1565C0), shape = MaterialTheme.shapes.medium) // Adjusted contrast
            .padding(16.dp)
    ) {
        Column {
            Text(
                ...
                color = Color.White,
                fontSize = 16.sp,
                fontWeight = FontWeight.Bold // Increased visibility
            )
            Text(
                text = "Rp. 27.950.000",
                color = Color.White,
...
private fun ActionButtons() {
    Row(
        ...
        ActionButton(Icons.Default.Add, "Add Action", "Add")
        ActionButton(Icons.Default.Send, "Send Money", "Send")
        ActionButton(Icons.Default.Menu, "View Account", "V. Account")
        ActionButton(Icons.Default.MoreVert, "More Options", "...")
    }
}

@Composable
private fun ActionButton(icon: ImageVector, contentDescription: String, label: String) {
    Column(
        ...
        Text(
            text = label,
            fontSize = 14.sp,
            color = Color(0xFF0D47A1), // Adjusted contrast
            fontWeight = FontWeight.Bold // Enhanced readability
        )
    }
}

...
private fun HeaderSection() {
    Row(
        ...
        Column {
            ...
            Text("Andhika Putra", style = TextStyle(fontSize = 20.sp, fontWeight = FontWeight.Bold))
            Text("9087890908", style = TextStyle(fontSize = 14.sp, color = Color.Gray))
        }
...
private fun BalanceSection() {
    Box(
        modifier = Modifier
            .fillMaxWidth()
            .background(Color(0xFF007FFF), shape = RoundedCornerShape(8.dp))
            .padding(16.dp),
...
private fun NewAccountModal() {
    Column(
        ...
        Text("New Account", style = TextStyle(fontSize = 18.sp, fontWeight = FontWeight.Bold, color = Color(0xFF007FFF)))
...
private fun CategoryChip(label: String, selected: Boolean = false) {
    Box(
        modifier = Modifier
            .background(
                if (selected) Color(0xFF007FFF) else Color.LightGray,
...
private fun AccountField(label: String, value: String) {
    Column(modifier = Modifier.fillMaxWidth()) {
        Text(label, style = TextStyle(fontSize = 14.sp, fontWeight = FontWeight.Bold, color = Color.Gray))

...
private fun ActionButtonsSection() {
    Row(
        ...
        ActionButton(icon = Icons.Default.Add, label = "Add New")
        ActionButton(icon = Icons.Default.ArrowForward, label = "Send")
        ActionButton(icon = Icons.Default.AccountBox, label = "V. Account")
    ...
    Card(
        ...
        Column(
            ...
            Image(
                ...
                contentDescription = "NFC Illustration",

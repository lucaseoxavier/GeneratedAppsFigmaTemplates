...
private fun HeaderSection() {
    Row(
        ...
        Column {
            Text("Hello,", style = TextStyle(fontSize = 18.sp, color = Color.White))
            Text("Andhika Putra", style = TextStyle(fontSize = 20.sp, fontWeight = FontWeight.Bold, color = Color.White))
            Text("9087890908", style = TextStyle(fontSize = 14.sp, color = Color.White))
        }
...
private fun BottomNavigationBar() {
    BottomAppBar(
        containerColor = Color(0xFF80C7FF),
        content = {
            Row(
                modifier = Modifier.fillMaxWidth(),
                horizontalArrangement = Arrangement.SpaceAround

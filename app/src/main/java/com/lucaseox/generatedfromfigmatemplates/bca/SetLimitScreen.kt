...
private fun LimitSettingsSection() {
    Column(
        ...
        LimitSlider(label = "Cash Withdrawal Limit", maxLimit = 7000000)
        LimitSlider(label = "Transfer Limit (BCA)", maxLimit = 25000000)
        LimitSlider(label = "Transfer Limit (Different Bank)", maxLimit = 10000000)
        LimitSlider(label = "Debit Transaction Debit", maxLimit = 25000000)
    }
}

@Composable
private fun LimitSlider(label: String, maxLimit: Int) {

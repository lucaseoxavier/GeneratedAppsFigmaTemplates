...
private fun AnimalCards() {
    Column(
        ...
        AnimalCard(title = "Lions", subtitle = "Mammifère", imageRes = R.drawable.lion_image)
        Spacer(modifier = Modifier.height(16.dp))
        AnimalCard(title = "Tigre", subtitle = "Mammifère", imageRes = R.drawable.tiger_image)
        Spacer(modifier = Modifier.height(16.dp))
        AnimalCard(title = "Tortue", subtitle = "Mammifère", imageRes = R.drawable.turtle_image)
        Spacer(modifier = Modifier.height(16.dp))
        AnimalCard(title = "Elephant", subtitle = "Mammifère", imageRes = R.drawable.elephant_image)
    }
}
